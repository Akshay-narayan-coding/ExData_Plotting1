...
data_output <- read.csv("household_power_consumption.txt",na.strings="?"")
data_subset <- data_output[data_output$Date %in% c("1/2/2007","2/2/2007") ,]
datetime <- strptime(paste(data_subset$Date, subSetData$Time, sep=" "), "%d/%m/%Y %H:%M:%S") 
